...
class Container_560e4a0932 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_560e4a0932 $container)
			{
	...
	public function createServiceContainer(): Container_560e4a0932
	{
		return $this;
	}
